// Centralized SQL statements and other constants
...
const SQL = {
	...
	getProductById: `
		...
		`,
	countProducts: "SELECT COUNT(*) as total FROM products WHERE is_active = true",
	...
	getCartItems: `
			...
			WHERE ci.user_id = ?
		`,
	checkCartItem: "SELECT * FROM cart_items WHERE user_id = ? AND product_id = ?",
	updateCartItem:
		"UPDATE cart_items SET quantity = quantity + ? WHERE user_id = ? AND product_id = ?",
	addCartItem: "INSERT INTO cart_items (user_id, product_id, quantity) VALUES (?, ?, ?)",
